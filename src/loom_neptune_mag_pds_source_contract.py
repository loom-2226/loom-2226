...
This module freezes the externally verified PDS source pairing before parser work.
It does not parse data, ingest records, interpolate samples, transform frames, or
provide any 2226 endpoint / admissibility / Loom-coherence authority.
"""
