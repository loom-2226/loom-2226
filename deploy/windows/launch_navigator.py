#!/usr/bin/env python3
"""Windows Navigator launcher using the explicit convergence root contract."""
from pathlib import Path
import os
import runpy

APP = Path(os.environ.get("LOOM_APP_ROOT") or os.environ.get("LOOM_HOME") or (Path.home() / "Documents" / "LOOM")).expanduser().resolve()
DATA = Path(os.environ.get("LOOM_DATA_ROOT") or (APP / "data")).expanduser().resolve()
