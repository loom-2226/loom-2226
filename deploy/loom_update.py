#!/usr/bin/env python3
"""LOOM 2226 updater/bootstrap v0.6.
...
def github_bytes(url,accept,*,label=None,expected_size=None):
 req=Request(url,headers={"Authorization":f"Bearer {token()}","Accept":accept,"X-GitHub-Api-Version":"2022-11-28","User-Agent":"LOOM-2226-Updater/0.6"})
