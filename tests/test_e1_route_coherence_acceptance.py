...
class E1RouteCoherenceAcceptanceTests(unittest.TestCase):
    ...
    def test_missing_uncertainty_blocks_certification_without_hard_fail(self):
        report = route_accept.classify_route_evidence(self._base_payload())
    ...
    def test_explicit_numeric_uncertainty_can_close_route_axis(self):
        payload = self._base_payload()
        payload["candidate"]["uncertainty"] = {"arrival_position_km_1sigma": 2.0}
    ...
    def test_qualified_lineage_uncertainty_artifact_can_close_route_axis_without_numeric_covariance(self):
        payload = self._base_payload()
        payload["route_uncertainty"] = {
            "disposition": "QUALIFIED_ROUTE_UNCERTAINTY_EVIDENCE",
    ...
    def test_unqualified_lineage_uncertainty_artifact_does_not_close_route_axis(self):
        payload = self._base_payload()
        payload["route_uncertainty"] = {
