...
**Status:** MVP / HOSTILE-REVIEW CANDIDATE  
...
### 6. SYSTEM DERATING
Translate material/device performance into installed-system performance. Include the burdens that make the consumer real: structure, reinforcement, insulation, cooling, shielding, control, protection, margins, geometry, lifetime, duty cycle, and balance-of-plant where applicable.
...
5. **Hindcast first.** Historical predictive failure blocks long-horizon authority.
6. **Horizon uncertainty.** Uncertainty must expand rather than disappear over a 200-year horizon.
7. **Physics wins.** Empirical trend cannot override a known physical constraint.
...
13. **Provenance survives.** Every downstream value remains traceable to observations, model, bounds, derating, and assumptions.
