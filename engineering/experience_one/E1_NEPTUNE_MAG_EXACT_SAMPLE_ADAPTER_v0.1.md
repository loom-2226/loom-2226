...
This work does not ingest a real PDS MAG row. It earns only the adapter contract required to expose a future ingested row without interpolation or hidden frame conversion.
